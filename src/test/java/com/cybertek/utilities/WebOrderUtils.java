...
public class WebOrderUtils {
    ...
    //Method take WebDriver object and String(name)
    //Method should verify if given name exists in orders.
    // This method shoul simply accepts a name (String) , and assert whether given name is an the list or not.
    ...
    public static void verifyOrder(WebDriver driver, String expectedName){
        ...
        //Asser.fail(); method will FAIL THE TEST NO MATTER WHAT.
